...
export default function ViewTeam() {
  ...
  return (
    <>
      <div id="teams" className="mt-5 d-flex flex-wrap">
        <div className="d-flex flex-column">
          <div className="text-white ms-5 details page-head">
            <img src={teamDetails.image} alt={teamDetails.name} />
            <h2>{teamDetails.team_name} </h2>
            <h3>{teamDetails.division} division</h3>
          </div>
          <h3 className="teamHead"> Add Members to Team</h3>
          ...
          <h3 className="teamHead">Members In Team</h3>
